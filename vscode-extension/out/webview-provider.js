...
exports.VirtualOfficePanel = void 0;
const vscode = __importStar(require("vscode"));
class VirtualOfficePanel {
    static currentPanel;
    panel;
    disposed = false;
    static createOrShow(context) {
        ...
        const panel = vscode.window.createWebviewPanel('claudeVirtualOffice', 'Claude Virtual Office', column, {
            enableScripts: true,
...
exports.VirtualOfficePanel = VirtualOfficePanel;
